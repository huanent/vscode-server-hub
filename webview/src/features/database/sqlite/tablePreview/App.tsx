...
import type { SqliteColumnInfo, SqliteTableFilter } from '../types';
import { useSqliteTablePreview } from './useSqliteTablePreview';

const pageSizes = [50, 100, 300, 500, 1000];

export function App() {
	const preview = useSqliteTablePreview();
...
type PreviewState = ReturnType<typeof useSqliteTablePreview>;
...
function RowField({ column, preview }: { column: SqliteColumnInfo; preview: PreviewState }) {
	const dialog = preview.dialog!;
